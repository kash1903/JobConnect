...
public class LandingController {
    ...
    public String handleRegistration(@RequestParam String name,
                                     ...
                                     Model model) {
        String apiUrl = "http://localhost:8081/api/users/register";
...
public String handleLogin(@RequestParam String email,
    ...
    String apiUrl = "http://localhost:8081/api/users/login";
    RestTemplate restTemplate = new RestTemplate();
    ...
    try {
        ...
        if (loginResponse == null || loginResponse.containsKey("error")) {
            System.out.println("Login failed: " + (loginResponse != null ? loginResponse.get("error") : "No response"));
